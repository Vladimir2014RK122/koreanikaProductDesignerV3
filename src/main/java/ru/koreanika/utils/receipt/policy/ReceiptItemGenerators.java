...
import ru.koreanika.utils.receipt.policy.mapper.*;
...
/**
 * Utility methods to convert items from table designer to data object format consumed by receipt builders.
 * Actual data conversion is performed by mappers implementing <code>ItemMapper</code> interface.
 * <p>
 * TODO Generated data is not cached, so a lot of excessive iteration is going on here. This is a legacy approach.
 */
public class ReceiptItemGenerators {

    // 1. TableDesignerSession.getTableDesignerAdditionalItemsList()
    ...
    public static List<ReceiptItem> getEdgesReceiptList() {
        ...
        return TableDesignerSession.getTableDesignerAdditionalItemsList().stream()
                .filter(i -> i instanceof EdgeItem)
                .map(i -> mapper.apply((EdgeItem) i))
    ...
    public static List<ReceiptItem> getBordersReceiptList() {
        ...
        return TableDesignerSession.getTableDesignerAdditionalItemsList().stream()
                .filter(i -> i instanceof BorderItem)
                .flatMap(i -> flatMapper.apply((BorderItem) i).stream())
                .filter(Objects::nonNull)
                .toList();
    }
    ...
    public static List<ReceiptItem> getSinkAcrylReceiptList() {
        ...
        return TableDesignerSession.getTableDesignerAdditionalItemsList().stream()
                .filter(i -> i instanceof SinkItem)
                .map(i -> mapper.apply((SinkItem) i))
                .filter(Objects::nonNull)
                .toList();
    }
    ...
    public static List<ReceiptItem> getPlumbingAlveusReceiptList() {
        ...
        return TableDesignerSession.getTableDesignerAdditionalItemsList().stream()
                .filter(i -> i instanceof PlumbingAlveusItem)
    ...
    public static List<ReceiptItem> getPlumbingReceiptList() {
        ...
        return TableDesignerSession.getTableDesignerAdditionalItemsList().stream()
                .filter(i -> i instanceof PlumbingItem plumbingItem)
    ...
    public static List<ReceiptItem> getPalletReceiptList() {
        ...
        return TableDesignerSession.getTableDesignerAdditionalItemsList().stream()
                .filter(i -> i instanceof PalletItem)
    ...
    public static List<ReceiptItem> getSinkInstallReceiptList() {
        ...
        return TableDesignerSession.getTableDesignerAdditionalItemsList().stream()
                .filter(i -> i instanceof SinkItem)
                .flatMap(i -> mapper.apply((SinkItem) i).stream())
                .filter(Objects::nonNull)
                .toList();
    }
    ...
    public static List<ReceiptItem> getSiphonReceiptList() {
        ...
        return TableDesignerSession.getTableDesignerAdditionalItemsList().stream()
                .filter(i -> i instanceof SiphonItem)
    ...
    public static List<ReceiptItem> getRodsReceiptList() {
        ...
        return TableDesignerSession.getTableDesignerAdditionalItemsList().stream()
                .filter(i -> i instanceof RodsItem)
                .map(i -> mapper.apply((RodsItem) i))
                .filter(Objects::nonNull)
                .toList();
    }
    ...
    public static List<ReceiptItem> getCutoutsReceiptList() {
        ...
        List<ReceiptItem> list1 = TableDesignerSession.getTableDesignerAdditionalItemsList().stream()
                .filter(i -> i instanceof CutoutItem)
                .map(i -> cutoutItemMapper.apply((CutoutItem) i))
                .filter(Objects::nonNull)
                .toList();
        cutoutsReceiptItems.addAll(list1);

        ItemMapper<RadiatorGroovesItem> radiatorGroovesItemMapper = new RadiatorGroovesItemMapper();
        List<ReceiptItem> list2 = TableDesignerSession.getTableDesignerAdditionalItemsList().stream()
                .filter(i -> i instanceof RadiatorGroovesItem)
                .map(i -> radiatorGroovesItemMapper.apply((RadiatorGroovesItem) i))
                .filter(Objects::nonNull)
                .toList();
    ...
    public static List<ReceiptItem> getGroovesReceiptList() {
        ...
        return TableDesignerSession.getTableDesignerAdditionalItemsList().stream()
                .filter(i -> i instanceof GroovesItem)
                .map(i -> mapper.apply((GroovesItem) i))
                .filter(Objects::nonNull)
                .toList();
    }

    // 2. TableDesignerSession.getTableDesignerMainWorkItemsList()
    ...
    public static List<ReceiptItem> getLeakGroovesReceiptItems() {
        ...
        return TableDesignerSession.getTableDesignerMainWorkItemsList().stream()
                .filter(i -> i instanceof LeakGrooveItem)
                .map(i -> mapper.apply((LeakGrooveItem) i))
                .filter(Objects::nonNull)
                .toList();
    }
    ...
    public static List<ReceiptItem> getJointsReceiptList() {
        ...
        return TableDesignerSession.getTableDesignerMainWorkItemsList().stream()
                .filter(i -> i instanceof JointItem)
                .map(i -> mapper.apply((JointItem) i))
                .filter(Objects::nonNull)
                .toList();
    }
    ...
    public static List<ReceiptItem> getRadiusReceiptList() {
        ...
        return TableDesignerSession.getTableDesignerMainWorkItemsList().stream()
                .filter(i -> i instanceof RadiusItem)
                .map(i-> mapper.apply((RadiusItem) i))
                .filter(Objects::nonNull)
                .toList();
    }
    ...
    public static List<ReceiptItem> getMeasurerReceiptList() {
        ...
        return TableDesignerSession.getTableDesignerMainWorkItemsList().stream()
                .filter(i -> i instanceof MeasurerItem)
    ...
    public static List<ReceiptItem> getDeliveryReceiptList() {
        ...
        return TableDesignerSession.getTableDesignerMainWorkItemsList().stream()
                .filter(i -> i instanceof DeliveryItem deliveryItem)
    ...
    public static List<ReceiptItem> getMountingReceiptList() {
        ...
        return TableDesignerSession.getTableDesignerMainWorkItemsList().stream()
                .filter(i -> i instanceof MountingItem)
    ...
    public static List<ReceiptItem> getCustomReceiptList() {
        ...
        return TableDesignerSession.getTableDesignerMainWorkItemsList().stream()
                .filter(i -> i instanceof CustomItem customItem)
    ...
    public static List<ReceiptItem> getDiscountReceiptList() {
        ...
        return TableDesignerSession.getTableDesignerMainWorkItemsList().stream()
                .filter(i -> i instanceof DiscountItem)
                .map(i -> mapper.apply((DiscountItem) i))
                .filter(Objects::nonNull)
                .toList();
    }

    // 3. TableDesignerSession.getTableDesignerAdditionalWorkItemsList()
