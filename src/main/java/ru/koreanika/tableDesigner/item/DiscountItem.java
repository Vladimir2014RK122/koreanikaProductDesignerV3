...
public class DiscountItem extends TableDesignerItem {
    ...
    public Map<String, ImageView> getMainImageView() {
        ...
        String imgPath = "/styles/images/TableDesigner/DiscountItem/discountItem.png";
        imagesList.put("Скидка#" + imgPath, new ImageView(getClass().getResource(imgPath).toString()));
    ...
    public void exitEditMode() {
        if(this.editModeProperty.get()){
            DiscountItem.exitFromEditMode(this);
        }
    }
    ...
    public void updateItemView(){
        ...
        labelHeaderCard.setText("Скидка");
        tooltipNameCard.setText("Скидка");
    ...
    public static AnchorPane getAnchorPaneSettingsView() {
        if (anchorPaneSettingsView == null) {
            FXMLLoader fxmlLoader = new FXMLLoader(EdgeItem.class.getResource("/fxmls/TableDesigner/TableItems/DiscountSettings.fxml"));
    ...
    private static void enterToEditMode(DiscountItem discountItem){
        TableDesigner.openSettings(DiscountItem.class);


        //get row data to settings
        textFieldPercent.setText("" + discountItem.percent);
        //disable button "add"
    ...
    public JSONObject getJsonView() {
        ...
        jsonObject.put("itemName", "DiscountItem");
    ...
    public static DiscountItem initFromJSON(JSONObject jsonObject) {
        ...
        DiscountItem discountItem = new DiscountItem(quantity, percent);
        //discountItem.quantity = quantity;
        discountItem.labelQuantity.setText("" + quantity);
        discountItem.updateRowPrice();
        return discountItem;
    }
}
