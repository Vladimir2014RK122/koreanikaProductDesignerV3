package utils.MaterialSelectionWindow.ListCellItems;
...
import utils.MaterialSelectionWindow.MaterialSettings;
...
public class MaterialListCellItem extends AnchorPane {
    ...
    public MaterialListCellItem(Material material) {
        ...
        else if(material.getCurrency().equals("EUR")){price = String.format(Locale.ENGLISH, "%.0f", priceForOne * RURToEUR);}
        else if(material.getCurrency().equals("USD")){price = String.format(Locale.ENGLISH, "%.0f", priceForOne * RURToUSD);}
        ...
        //if(material.getAvailableMainSheetsCount() != 0) btnEdit.setDisable(true);
