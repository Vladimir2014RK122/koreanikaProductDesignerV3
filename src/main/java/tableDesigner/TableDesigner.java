...
public class TableDesigner {
    ...
    public TableDesigner() {
        ...
        //fxmlLoader.setLocation(this.getClass().getResource("/fxmls/TableDesigner/tableDesigner.fxml"));
        try {
